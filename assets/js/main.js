const toolsDataJSON = '{"bootstrap":{"name":"Bootstrap","classification":"frontend","info":"quick prototyping"},"css3":{"name":"CSS3","classification":"frontend","info":"markup language for styling"},"expressjs":{"name":"Express JS","classification":"backend","info":"our ecommerce API was design with Express"},"git":{"name":"Git","classification":"backend","info":"version control system - concurrent code contribution was made possible"},"gitlab":{"name":"GitLab","classification":"backend","info":"our chosen online repo for our React group project"},"heroku":{"name":"Heroku","classification":"backend","info":"where I deployed my ecommerce API"},"html5":{"name":"HTML5","classification":"frontend","info":"for semantic markup"},"javascript":{"name":"JavaScript","classification":"frontend","info":"core language for page behavior"},"mongodb":{"name":"MongoDB","classification":"backend","info":"quick and lightweight db, preferred store for our ecommerce products data"},"nodejs":{"name":"Node.js","classification":"backend","info":"backend environment for JavaScript which ran our Express API"},"postman":{"name":"Postman","classification":"backend","info":"API development and testing"},"reactjs":{"name":"React","classification":"frontend","info":"JavaScript library for for our React Ecommerce Frontend"}}';
